...
class AutoBidInfoEdit extends Component{
    constructor(){
        super();
    }
    componentWillMount(){
        ...
        this.state = {
            actualAmt : 0,   //账户余额
            investAmount : params.investAmount,  //投标金额
            reservedAmount : params.reservedAmount,  //账户保留金额
            isMatchCoupon : params.isMatchCoupon,  //是否自动匹配优惠券 0:否 1:是
            projectPeriodMonth: {  //项目期限列表(天)
                select: {
                    label: params.projectPeriodMonth+'天',
                    value: '1'
                },
                data: [
        ...
        Utils.tokenExpireJumpToLogin(function () {
            ...
            Utils.requestData({
                ...
                callback: function(data){
                    ...
                    //项目期限列表(天)
                    let projectPeriodMonthList = data.data.projectPeriodMonthList;
                    ...
                    //年化收益列表(%)
                    let yearRateList = data.data.yearRateList;
    ...
    render(){
        ...
        return (
            ...
            <Backbar $id="autoBidInfoEdit" title="自动投标" action="autoBid">
                    ...
                    <ul className="a-list">
                        <li>
                            ...
                            <div className={
                                ...
                                <Picker $id="picker-autoBidInfoEdit-period"
                                        onYes={(data)=>{
                        ...
                        <li>
                            ...
                            <div className={
                                ...
                                <Picker $id="picker-autoBidInfoEdit-yearRate"
                                        onYes={(data)=>{
                            ...
                            if(this.state.projectPeriodMonth.select.value==0){
                                ...
                                Utils.requestData({
                                    ...
                                    data:{
                                        ...
                                        "ruleId": Utils.Url.parseUrl(location.href).params.ruleId
                                    },
                                    callback: function(data){
                        ...
                        <span className="a-btn" onClick={()=>{
                            ...
                            Modal.alert('提示',"确定关闭自动投标？", [
                                ...
                                { 
                                    ...
                                    onPress:()=>{
                                        Utils.requestData({
                                            url: config.api + 'qj/front/v1/autoInvest/deleteMemberInvestRule',
                                            method: 'post',
                                            data:{
                                                "ruleId": Utils.Url.parseUrl(location.href).params.ruleId
                                            },
                                            callback: function(data){
                                                ...
                                                if(data.resultCode==0){
                                                    ...
                                                    Toast.success('关闭成功', 1, ()=>{
                                                        ...
                                                        if(Utils.Url.parseUrl(location.href).params.listLength==1){
...
export default AutoBidInfoEdit;
